...
<div class="box-tabs-container box-tabs-left clearfix">
	<?php if($user_row['name'] == $name && $edit_mode !== true){ ?><a href="user_profile.php?do=edit&name=<?php echo FilterText($name); ?>" id="edit-button" class="new-button dark-button edit-icon" style="float:left"><b><span></span>Modifier</b><i></i></a><?php } ?>
