...
<?php } ?>
<p class="btn">Si vous n'&ecirc;tes pas redirig&eacute; automatiquement, s'il vous pla&icirc;t <a href="index.php" id="manual_redirect_link">cliquer ici</a></p>
