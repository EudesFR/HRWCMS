...
<?php	} ?>
        <li class="selected"><a href="<?php if($row['forumid'] != 0) { echo "group_"; } ?>forum.php<?php if($row['forumid'] != 0) { ?>?id=<?php echo $groupid; } ?>">Forum de discussion </a><span class="tab-spacer"></span></li>
    </ul>
</div>
    ...
    <div class="postlist-header clearfix">
				...
				if($row['topics'] == 0) {
					...
					if(mysql_num_rows($check) > 0) { 
						$asdf = "<a href=\"#\" id=\"create-post-message\" class=\"create-post-link verify-email\">Repondre</a>";
						$zxcv = "<a href=\"#\" class=\"quote-post-link verify-email\" id=\"quote-post-".$row['id']."-message\">Quote</a>";
					}
				}elseif($row['topics'] == 2) {
					...
					if(mysql_num_rows($check) > 0) { 
						$asdf = "<a href=\"#\" id=\"create-post-message\" class=\"create-post-link verify-email\">r&eacute;pondre</a>";
						$zxcv = "<a href=\"#\" class=\"quote-post-link verify-email\" id=\"quote-post-".$row['id']."-message\">Citation</a>";
					}
				}
				?>
				...
				if(mysql_num_rows($hid) > 0) { ?><a href="#" id="edit-topic-settings" class="edit-topic-settings-link">Outils de mod&eacute;ration &raquo;</a>
                <input type="hidden" id="settings_dialog_header" value="Moderation Tools"/>
				<?php
				}elseif($user_rank > 5){ ?><a href="#" id="edit-topic-settings" class="edit-topic-settings-link">Outils de mod&eacute;ration &raquo;</a>
...
echo "                ".$zxcv;
			...
			if($user_rank > 5 || $my_id == $userdata['id'] && $logged_in){
	                echo "<a href=\"#\" class=\"edit-post-link verify-email\" id=\"edit-post-".$row['id']."-message\">Modifier</a>";
			}
...
<div id="new-post-preview" style="display:none;">
    ...
    <div class="postlist-footer clearfix">
		<?php if($topic_open && $logged_in){ ?><?php echo $asdf ?></a><?php } elseif($logged_in){ ?><span class="topic-closed"><img src="./web-gallery/images/groups/status_closed.gif" title="Closed Thread"> Closed Thread</span><?php } else { echo "</a>Vous devez &ecirc;tre connect&eacute; pour r&eacute;pondre ou poster de nouveaux sujet."; } ?>
...
L10N.put("myhabbo.discussion.error.topic_name_empty", "Titre du sujet ne droit pas &ecirc;tre vide");
...
Event.observe("dialog-group-settings-exit", "click", function(e) {
	...
	<p class="clearfix">
		<a href="#" id="postentry-verifyemail-ok" class="new-button"><b>Annuler</b><i></i></a>
	</p>
	</div>
</div>	
...
<form method="post" id="postentry-delete-form">
	...
	<p class="clearfix">
		<a href="#" id="postentry-delete-cancel" class="new-button"><b>Annuler</b><i></i></a>
