    ...
    <?php @include('tagcloud.php'); ?>
				...
				<div class="habblet-container ">
						<div class="cbb clearfix default ">
							...
							<h2 class="title">Combat de tags
							</h2>
						<div id="tag-fight-habblet-container">
<div class="fight-process" id="fight-process">Et le gagnant est..</div>
<div id="fightForm" class="fight-form">
    <div class="tag-field-container">1er tag :<br /><input maxlength="30" type="text" class="tag-input" name="tag1" id="tag1"/></div>
    <div class="tag-field-container">2ème tag :<br /><input maxlength="30" type="text" class="tag-input" name="tag2" id="tag2"/></div>
</div>
<div id="fightResults" class="fight-results">
    <div class="fight-image">
        ...
        <a id="tag-fight-button" href="#" class="new-button" onclick="TagFight.init(); return false;"><b>Combat!</b><i></i></a>
    </div>
</div>
...
<div id="column2" class="column">
				<div class="habblet-container ">
						<div class="cbb clearfix default ">
							...
							<h2 class="title">Cherches des tags <?php if($valid_search == true){ echo "(" . $results . ")"; } ?>
							</h2>
...
</form>        <?php if($results > 0){ echo "<br /><p class=\"search-result-count\">1 - " . $results . " / " . $results . "</p>"; } else { echo "<p class=\"search-result-count\">Pas de r&eacute;sutats.</p>"; } ?>
                <?php if($valid_search == true && $logged_in == true && $valid_tag == true && $already_tagged == false){ echo "<p id=\"tag-search-add\" class=\"clearfix\"><span style=\"float:left\">Avoir ce tag?</span> <a id=\"tag-search-tag-add\" href=\"tags.php?tag=".trim(HoloText($query))."&add=true\" class=\"new-button\" style=\"float:left\"><b>".trim(HoloText($query))."</b><i></i></a></p>"; } ?>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" class="search-result">
        ...
        <?php
                ...
                <td class=\"image\" style=\"width:39px;\">
                    <img src=\"http://www.habbo.fr/habbo-imaging/avatarimage?figure=".$userdata['figure']."&size=s&direction=4&head_direction=4&gesture=sml\" alt=\"".$userdata['name']."\" align=\"left\"/>
                </td>
                <td class=\"text\">
