...
<ul>
    <li>
        <a href="news.php" class="article">Voir toutes les news</a> &raquo;
    </li>
</ul>
...
<h2><?php echo "".$shortname." News"; ?></h2>
    <div class="article-meta">Voici les news, class&eacute;es de la plus vieille &agrave; la plus r&eacute;cente.</div>
    <div class="article-body">
        <p>
        <ul>
        <?php
...
function ejs_nodroit()
    {
    alert('Interdiction de nous copier ou prendre des sources !!.');
    return(false);
    }
