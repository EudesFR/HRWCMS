...
echo "<font color='white'><center><b>".$sitename." est ferm&eacute;</b></center></font>";
exit();
}
...
if($row['loader'] == 1) { ?>
<div id="clientembed-loader" style="display:none"><div><b>Ouverture de.. <?php echo $shortname; ?>...</b></div></div><?php } ?>
<div id="clientembed">
...
HabboClientUtils.showLoader(["Ouverture de <?php echo $shortname; ?>&nbsp;&nbsp;&nbsp;", "Veuillez patienter..", "Ouverture de <?php echo $shortname; ?>..&nbsp;", "Bon s&eacute;jour sur <?php echo $shortname; ?>!"]);
</script><?php } ?>
</div>
<?php echo $analytics; ?>
</body>
