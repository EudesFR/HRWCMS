...
<p>Tu veux donc <?php echo $months; ?> mois de <?php echo $shortname; ?> Club? (<?php echo $months * 31; ?> jours) c&ocirc;utent <?php echo $price; ?> Cr&eacute;dits. 	Tu as: <?php echo $myrow['credits']; ?> Cr&eacute;dits.</p>
