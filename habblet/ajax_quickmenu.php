...
$oddeven = 0;
	...
	if($mode == "3"){
	echo "<p class=\"create-room\"><a href=\"client.php?shortcut=roomomatic\" onclick=\"HabboClient.openShortcut(this, 'roomomatic'); return false;\" target=\"client\">Cr&eacute;er un appart</a></p>";
	} elseif($mode == "2"){
