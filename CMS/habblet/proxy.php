...
while ($row = mysql_fetch_assoc($getem)) {
    ...
    <span class=\"clearfix enter-room-link room-occupancy-%s\" title=\"Go to room\" roomid=\"%s\">
		...
		<span class=\"room-owner\">Propri&eacute;taire: <a href=\"user_profile.php?name=%s\">%s</a></span>
    </span>
...
?>
            ...
            <div class="clearfix">
                <a href="#" class="room-toggle-more-data" id="room-toggle-more-data-h120">Plus d'apparts</a>
            </div>
</div>
<script type="text/javascript">
L10N.put("show.more", "Plus d'apparts");
L10N.put("show.less", "Moins d'apparts");
...
?>
    ...
    <div class="clearfix">
        <a href="#" class="hotgroups-toggle-more-data secondary" id="hotgroups-toggle-more-data-h122">Plus de clans</a>
    </div>
<script type="text/javascript">
L10N.put("show.more.groups", "Plus de clans");
L10N.put("show.less.groups", "Moins de clans");
