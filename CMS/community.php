...
<div id="container">
    ...
    if($row['owner'] !== ""){ // Public Rooms (and possibly bugged rooms) have no owner, thus do not display them
        ...
        printf("<li class=\"%s\">
            ...
            <span class=\"room-owner\">Visiteurs: <b>%s</b></span>
...
<div class="habblet-container ">
  <div class="cbb clearfix activehomes ">
     ...
     <h2 class="title"><?php echo $shortname; ?>s au hasard - Cliques dessus!
     </h2>
     <div id="homes-habblet-list-container" class="habblet-list-container">
       ...
       printf("        <div id=\"active-habbo-data-%s\" class=\"active-habbo-data\">
        ...
        Habbo cr&eacute;e le: %s
        <p class=\"moto\">%s</p>
        </div>
        </div>
        <input type=\"hidden\" id=\"active-habbo-url-%s\" value=\"user_profile.php?name=%s\"/>
        <input type=\"hidden\" id=\"active-habbo-image-%s\" class=\"active-habbo-image\" value=\"http://www.habbo.co.uk/habbo-imaging/avatarimage?figure=%s&size=b&direction=3&head_direction=3&gesture=sml\n\" />", $list_id, $status, $row['name'], $row['hbirth'], HoloText($row['mission']), $list_id, $row['name'], $list_id, $row['figure']);
   }
   ?>
      ...
      <div class="cbb clearfix notitle ">
          ...
          <div id="newspromo">
           ...
           <ul class="widelist">
            ...
            <li class="last"><a href="news.php">Plus de news &raquo;</a></li>
        </ul>
    </div>
    <script type="text/javascript">
...
<div class="habblet-container ">
  <div class="cbb clearfix red ">
     ...
     <h2 class="title">Les Habbos aiment..
     </h2>
