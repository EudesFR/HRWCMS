...
printf("        <div id=\"active-habbo-data-%s\" class=\"active-habbo-data\">
                ...
                <input type=\"hidden\" id=\"active-habbo-image-%s\" class=\"active-habbo-image\" value=\"http://www.habbo.fr/habbo-imaging/avatarimage?figure=%s&size=b&direction=3&head_direction=3&gesture=sml\n\" />", $list_id, $status, $row['name'], $row['hbirth'], HoloText($row['mission']), $list_id, $row['name'], $list_id, $row['figure']);
}
?>
