...
if(empty($news_1_title)){ $news_1_title = "News non trouv&eacute;e"; }
if(empty($news_1_snippet)){ $news_1_snippet = "Cet article n'existe pas."; }
...
if(empty($news_2_title)){ $news_2_title = "News non trouv&eacute;e"; }
if(empty($news_2_snippet)){ $news_2_snippet = "Cet article n'existe pas."; }
...
if(empty($news_3_title)){ $news_3_title = "News non trouv&eacute;e"; }
if(empty($news_3_date)){ $news_3_date = "Cet article n'existe pas."; }
...
if(empty($news_4_title)){ $news_4_title = "News non trouv&eacute;e"; }
if(empty($news_4_date)){ $news_4_date = "Cet article n'existe pas."; }
