...
<?php } ?>
	...
	<div id="habbo-plate">
		<a href="account.php?tab=1">
			<img alt="<?php echo $name; ?>" src="http://www.habbo.fr/habbo-imaging/avatarimage?figure=<?php echo $myrow['figure']; ?>&size=b&direction=4&head_direction=3&gesture=sml" width="64" height="110" />
		</a>
	</div>
...
<li id="feed-item-hc-reminder">
    ...
    <div>
        <?php if(mysql_num_rows($sql) == 0) { ?>    Your <?php echo $shortname; ?> Le club est expiré. Veux-tu étendre ton <?php echo $shortname; ?> Club?<?php } ?>
    </div>
...
<li id="feed-birthday">
    <div>
            Joyeux <?php echo $age; ?> Ans, <?php echo $name; ?>!<br />Nous te shouaitons une bonne journée !
    </div>
</li>
<?php } ?>
<?php
