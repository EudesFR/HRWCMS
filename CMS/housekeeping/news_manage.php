...
<form action='index.php?p=news_manage&do=save' method='post' name='theAdminForm' id='theAdminForm'>
 ...
 <tr>
  ...
  <td class='tablesubheader' width='10%' align='center'>Editer</td>
  <td class='tablesubheader' width='12%' align='center'>Supprimer</td>
 </tr>
<?php
...
?>
 ...
 <div class='tablefooter' align='center'><div class='fauxbutton-wrapper'><span class='fauxbutton'><a href='index.php?p=news_compose'>Composer une nouvelle News</a></span></div></div>
</div>
<?php } else { ?>
<form action='index.php?p=news_manage&do=save&key=<?php echo $article['num']; ?>' method='post' name='theAdminForm' id='theAdminForm'>
<div class='tableborder'>
<div class='tableheaderalt'>Editer l'article(<?php echo $article['title']; ?>)</div>

<table width='100%' cellspacing='0' cellpadding='5' align='center' border='0'>
<tr>
<td class='tablerow1'  width='40%'  valign='middle'><b>Titre</b><div class='graytext'>The full title of your article.</div></td>
