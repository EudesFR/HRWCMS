...
Ceci est un aperçu de l'historique des transactions de crédit. Ils sont mis à jour dès que la transaction est faite. Vous pouvez voir jusqu'à 50 enregistrements.
</div>
...
<thead>
	<tr>
		...
		<th class="tx-amount">Activité</th>
...
<ul>
    <li class="even icon-purse">
        ...
        <span class="purse-balance-amount"><?php echo $myrow['credits']; ?> Crédits</span>
        <div class="purse-tx"><a href="transactions.php">Mes transactions</a></div>
    </li>

    <li class="odd">
        <div class="box-content">
            <div>Entre un code crédits:</div>
